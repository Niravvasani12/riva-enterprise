...
const Contact = () => {
  return (
    <>
      <SEO
        title="Contact Us"
        description="Contact Riva Enterprise in Surat for DTF printing, custom transfer printing, reseller orders, bulk production, WhatsApp support, and fast pricing help."
        keywords={[
          "contact Riva Enterprise",
          "DTF printing Surat contact",
          "DTF print order Gujarat",
          "custom printing Surat",
          "bulk DTF printing contact",
        ]}
        structuredData={(siteUrl, canonicalUrl) => ({
          ...
          address: {
            "@type": "PostalAddress",
            streetAddress:
              "Shop No. 2, Godavari Society Vibhag 2, Nr Ganesh Ice Cream, Kiran Chowk",
